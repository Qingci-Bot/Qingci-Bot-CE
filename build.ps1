...
Write-Host "==> [0/3] installing qingci-plugin-sdk (v1.13.5)..." -ForegroundColor Cyan
uv pip install --python $Python "qingci-plugin-sdk @ git+https://gitee.com/qingci-bot/Plugins-SDK.git@v1.13.5"
