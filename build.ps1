...
Write-Host "==> [0/3] installing qingci-plugin-sdk (v1.10.1)..." -ForegroundColor Cyan
uv pip install --python $Python "qingci-plugin-sdk @ git+https://gitee.com/qingci-bot/Plugins-SDK.git@v1.10.1"
